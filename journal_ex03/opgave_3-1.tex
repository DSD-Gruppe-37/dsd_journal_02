...
Ved sammenligning RTL-views ses det funktionaliteten i de adders er ens, dette vises på \figref{fulladdersRTL} og ses på technology map viewet i \figref{unsignedsignedpostmap}
