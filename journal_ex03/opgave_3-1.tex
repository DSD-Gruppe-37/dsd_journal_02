...
Ved sammenligning RTL-views ses det funktionaliteten i de adders er ens, dette vises på \figref{ex3-1-fulladdersRTL} og ses på technology map viewet i \figref{ex3-1-unsignedsignedpostmap}
